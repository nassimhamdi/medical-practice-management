...
//*********************************************************************
    ...
    public Employee getEmployeeFromData() {
        ...
        UserEntity user =new UserEntity(firstName, lastName, username, email, password, role, cellNo);
...
//***************************************************************************
    ...
    public static EmployeeUserDataBacking createUser(UserEntity user) {
    ...
    public static Employee updateEmployee(int userId,EmployeeUserDataBacking userData) {
        ...
        UserEntity corruspondingUser=new UserEntity();
